                ...
                {NAV_ITEMS.map((item, index) => (
                  <div key={index}>
                    {item.hasSubmenu ? (
                      ...
                      <Link href={item.href} className="text-lg font-medium block py-2 hover:text-blue-500">
                        {item.title}
                      </Link>
                    )}
                  </div>
                ...
                {item.hasSubmenu ? (
                  <>
                    ...
                    <NavigationMenuTrigger 
                      ...
                      className="bg-transparent text-gray-400 hover:text-white hover:bg-white/5 data-[active]:bg-white/5 data-[state=open]:bg-white/5 focus:bg-transparent focus:text-white focus:outline-none cursor-pointer transition-colors"
                    >
                      {item.title}
                    </NavigationMenuTrigger>
