...
const HeroSplit = ({ onEnter }: HeroSplitProps) => {
  ...
  return (
    <section className="relative w-full h-screen bg-[#050505] overflow-hidden flex flex-col items-center justify-center z-50">
      ...
      {/* --- DESKTOP VIEW --- */}
      <div className="hidden md:flex w-full max-w-7xl mx-auto h-full items-center justify-center relative z-10">
        ...
        >
            {/* The Ring Visuals */}
            <div className="absolute inset-[2px] rounded-full border-[10px] border-transparent" style={{ background: "linear-gradient(#050505, #050505) padding-box, linear-gradient(to right, #BF953F, #FCF6BA, #B38728) border-box", }} />
            ...
            {/* Images */}
            <motion.div 
              className="absolute top-12 left-12 w-[350px] h-[350px] pointer-events-none"
              animate={{ 
